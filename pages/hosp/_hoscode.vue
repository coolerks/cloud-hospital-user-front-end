...
import {getDepartmentByHoscode, getHospitalDetailByHoscode} from "~/api/hospital";
...
export default {
    ...
    methods: {
        async init() {
            ...
            // })
            let detail = (await getHospitalDetailByHoscode(this.hoscode)).data;
            this.hospital = detail;
            this.bookingRule = detail.bookingRule;
            this.departmentVoList = (await getDepartmentByHoscode(this.hoscode)).data;
        },
